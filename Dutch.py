...
tokenizer = WhisperTokenizer.from_pretrained(model_checkpoint, language="Dutch", task="transcribe")
processor = WhisperProcessor.from_pretrained(model_checkpoint, language="Dutch", task="transcribe")
